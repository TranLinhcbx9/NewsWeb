...
{
    public class MongoDbNewsWebDbSchemaMigrator : INewsWebDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbNewsWebDbSchemaMigrator(IServiceProvider serviceProvider)
        {
